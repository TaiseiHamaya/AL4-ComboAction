...
void SceneTitle::load() {
	...
	TextureLibrary::RegisterLoadQue("./Resources/title.png");
}

void SceneTitle::initialize() {
	Camera2D::Initialize();

	title = eps::CreateUnique<SpriteInstance>("title.png", Vector2{ 0.5f, 0.5f });
	title->get_transform().set_translate(EngineSettings::CLIENT_SIZE / 2 + Vector2{ 0, 128 });
